...
public class XToastHandler extends Handler{
    ...
    private void hideToast(final XToast xToast) {
        AnimatorSet set = xToast.getmHideAnimatorSet();
        set.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                xToast.getmViewGroup().removeView(xToast.getmView());
                xToast.getmOnDisappearListener().onDisappear(xToast);
                mQueue.poll();
    ...
    private void showToast(XToast xToast) {
        ...
        xToast.getmViewGroup().addView(xToast.getmView());
        //获取动画效果
        AnimatorSet set = xToast.getmShowAnimatorSet();
        set.start();

        Message message = Message.obtain();
        message.what = HIDE_TOAST;
        message.obj = xToast;
        sendMessageDelayed(message,xToast.getmDuration());
    }
